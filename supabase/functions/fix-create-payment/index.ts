// supabase/functions/fix-create-payment/index.ts - Исправленная версия
...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Проверяем текущую подписку через profiles
    ...
    // Если уже Pro и пытается купить Pro
    ...
    // Генерируем payment URL (для тестов - заглушка)
