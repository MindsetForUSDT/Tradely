    ...
    <footer className="relative z-10 border-t border-surface-border/30 mt-auto">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/#features" className="text-xs text-text-muted hover:text-text-primary">
                  Возможности
                </Link>
              </li>
              <li>
                <Link to="/subscribe" className="text-xs text-text-muted hover:text-text-primary">
                  Тарифы
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/terms" className="text-xs text-text-muted hover:text-text-primary">
                  Условия
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-xs text-text-muted hover:text-text-primary">
                  Конфиденциальность
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 pt-6 border-t border-surface-border/20 text-center">
          <p className="text-xs text-accent-red/60 mb-2">
            Не является инвестиционной рекомендацией. Торговля сопряжена с риском потери капитала.
          </p>
