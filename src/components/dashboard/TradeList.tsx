...
interface TradeListProps {
  ...
  compact?: boolean; // ✅ Добавлен проп
}

const ROW_HEIGHT = 64;
const OVERSCAN = 10;

export function TradeList({ trades, isLoading = false, onTradeClick, compact }: TradeListProps) {
      ...
      >
        ...
        <div className="w-20 text-right flex-shrink-0">
          <p className="text-[10px] text-text-muted font-mono">
            {trade.tx_hash ? shortenAddress(trade.tx_hash, 4) : '—'}
          </p>
        </div>
      </div>
    ),
